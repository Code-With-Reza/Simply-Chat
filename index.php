...
$db_user = getenv('DB_USERNAME') ?: 'chatuser';   // Diperbarui
$db_pass = getenv('DB_PASSWORD') ?: 'chatpass';   // Diperbarui
$db_port = getenv('DB_PORT') ? (int)getenv('DB_PORT') : 3306; // Ditambahkan
...
// 2. SETUP DATABASE
// ==========================================
// Coba koneksi langsung ke database yang sudah disediakan oleh Wasmer Edge
$conn = @new mysqli($db_host, $db_user, $db_pass, $db_name, $db_port);

// Fallback: Jika gagal, mungkin database belum dibuat (untuk testing lokal)
